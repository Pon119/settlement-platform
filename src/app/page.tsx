      ...
      <div className="min-h-screen flex items-center justify-center px-4 py-8 relative">
        <div className="text-center max-w-4xl mx-auto w-full">
          ...
          <button
            ...
            className="fixed top-4 right-4 z-40 w-12 h-12 bg-white hover:bg-gray-50 border border-gray-200 shadow-sm rounded-full flex items-center justify-center text-gray-600 text-xl font-bold transition-all hover:shadow-md"
            aria-label="사용법 가이드"
          >
            ?
          </button>
          ...
          {/* 메인 제목 */}
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-warm-dark mb-4 sm:mb-6">
            🧮 함께정산
          </h1>
          <p className="text-lg sm:text-xl text-warm-gray mb-8 sm:mb-12 leading-relaxed px-4">
            친구들과 쉽고 투명한 정산을 경험해보세요<br className="hidden sm:block"/>
            <span className="sm:hidden"> </span>복잡한 계산은 자동으로, 송금은 간편하게!
          </p>

          {/* CTA 버튼들 - 모바일 최적화 */}
          <div className="space-y-4 sm:space-y-0 sm:space-x-4 sm:flex sm:justify-center mb-12 sm:mb-16 px-4">
            <Link
              href="/groups/create"
              className="block w-full sm:w-auto bg-[#D4537E] hover:bg-[#C44070] text-white px-6 sm:px-8 py-4 rounded-xl font-semibold text-lg transition-all transform hover:scale-105 shadow-md hover:shadow-lg"
            >
              새 그룹 만들기
            </Link>
            <button
              onClick={() => setShowGuide(true)}
              className="block w-full sm:w-auto bg-white hover:bg-gray-50 text-gray-700 px-6 sm:px-8 py-4 rounded-xl font-semibold text-lg transition-all transform hover:scale-105 border border-gray-200 shadow-sm"
            >
              사용법 보기
            </button>
          </div>
          ...
          {/* 기능 카드들 - 모바일 최적화 */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 px-4">
            <div className="bg-white border border-gray-100 shadow-sm rounded-2xl p-6 hover:shadow-md transition-shadow text-left">
            ...
            <div className="bg-white border border-gray-100 shadow-sm rounded-2xl p-6 hover:shadow-md transition-shadow text-left sm:col-span-2 lg:col-span-1">
              <div className="text-4xl mb-4">🏦</div>
              <h3 className="font-semibold text-lg mb-2 text-warm-dark">계좌 연동</h3>
              <p className="text-sm text-warm-gray">클릭 한 번으로 계좌번호 확인 및 복사</p>
            </div>
          </div>

          {/* 추가 기능들 */}
          <div className="mt-10 sm:mt-12 grid grid-cols-1 sm:grid-cols-2 gap-5 px-4">
            <div className="bg-white border border-gray-100 shadow-sm rounded-2xl p-6 hover:shadow-md transition-shadow text-left">
            ...
            <div className="sticky top-0 bg-white border-b border-gray-100 p-6 rounded-t-2xl">
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  className="w-8 h-8 bg-gray-100 hover:bg-gray-200 rounded-full flex items-center justify-center font-bold text-gray-500 transition-colors"
                >
                  ×
                </button>
              </div>
            ...
            <div className="p-6 space-y-8">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3 p-4 bg-pink-50 rounded-xl border border-pink-100">
                    <div className="w-8 h-8 bg-[#D4537E] text-white rounded-full flex items-center justify-center font-bold text-sm flex-shrink-0">1</div>
                    <div>
              ...
              <div className="text-center pt-4 border-t border-gray-100">
                <Link
                  href="/groups/create"
                  onClick={() => setShowGuide(false)}
                  className="inline-block bg-[#D4537E] hover:bg-[#C44070] text-white px-8 py-3 rounded-xl font-semibold text-lg transition-all transform hover:scale-105 shadow-md"
                >
                  🚀 지금 시작하기
                </Link>
              </div>
